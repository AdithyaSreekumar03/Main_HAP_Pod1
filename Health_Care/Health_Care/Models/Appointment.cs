...
namespace HealthApp.Models
{
    ...
    public class Appointment
    {
        ...
        {
            return $"Appointment ID: {AppointmentId}, Patient Name: {Patient.FullName},Doctor Name:Dr.{Doctor.doctorName} ({Doctor.Specialisation}),Date: {ScheduledDate:dd-MM-yyyy},TimeSlot: {TimeSlot}, Status: {Status},Cancellation Reason:{{CancellationReason ?? \"N/A\"}}";
        }
